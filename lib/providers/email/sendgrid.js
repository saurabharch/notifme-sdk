  ...
  (0, _createClass3.default)(EmailSendGridProvider, [{
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(request) {
        var _ref2, id, userId, from, replyTo, subject, html, text, headers, to, cc, bcc, attachments, categories, generatedId, response, responseBody, _responseBody$errors, firstError, message;
