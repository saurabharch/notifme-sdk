  ...
  (0, _createClass3.default)(EmailSendGridProvider, [{
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(request) {
        var id, userId, from, replyTo, subject, html, text, headers, to, cc, bcc, attachments, categories, generatedId, response, responseBody, _responseBody$errors, firstError, message;

        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                id = request.id, userId = request.userId, from = request.from, replyTo = request.replyTo, subject = request.subject, html = request.html, text = request.text, headers = request.headers, to = request.to, cc = request.cc, bcc = request.bcc, attachments = request.attachments, categories = request.categories;
