...
// Types
var PushAdmProvider = function () {
  function PushAdmProvider(config) {
    (0, _classCallCheck3.default)(this, PushAdmProvider);
    this.id = 'push-adm-provider';

    this.transporter = new _nodePushnotifications2.default({ adm: (0, _extends3.default)({}, config, {
        client_id: config.clientId,
        client_secret: config.clientSecret
      }) });
  }

  (0, _createClass3.default)(PushAdmProvider, [{
    key: 'send',
    value: function () {
  ...
  return PushAdmProvider;
}();

exports.default = PushAdmProvider;