...
var NotifmeSdk = function () {
  function NotifmeSdk(options) {
    ...
    this.sender = new _sender2.default((0, _keys2.default)(CHANNELS), providers, strategies);
  }
  ...
  (0, _createClass3.default)(NotifmeSdk, [{
    ...
    value: function mergeWithDefaultConfig(_ref) {
      ...
      return (0, _extends3.default)({
        ...
        channels: rest.useNotificationCatcher ? _notificationCatcherProvider2.default.getConfig((0, _keys2.default)(CHANNELS)) : {
